...
namespace MH.Infrastructure.Migrations
{
    ...
    [Migration("20230303115806_add-UserId-UserProfile-table")]
    partial class addUserIdUserProfiletable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MH.Domain.DBModel.City", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 132, DateTimeKind.Utc).AddTicks(7422));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 132, DateTimeKind.Utc).AddTicks(9331));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.Country", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 133, DateTimeKind.Utc).AddTicks(3234));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 133, DateTimeKind.Utc).AddTicks(4585));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.State", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 181, DateTimeKind.Utc).AddTicks(4669));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 58, 5, 181, DateTimeKind.Utc).AddTicks(5767));
