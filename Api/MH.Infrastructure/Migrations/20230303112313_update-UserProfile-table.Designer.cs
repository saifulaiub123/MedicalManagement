...
namespace MH.Infrastructure.Migrations
{
    ...
    [Migration("20230303112313_update-UserProfile-table")]
            ...
            modelBuilder.Entity("MH.Domain.DBModel.City", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 870, DateTimeKind.Utc).AddTicks(8871));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 871, DateTimeKind.Utc).AddTicks(913));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.Country", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 871, DateTimeKind.Utc).AddTicks(3907));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 871, DateTimeKind.Utc).AddTicks(5343));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.State", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 923, DateTimeKind.Utc).AddTicks(7012));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 11, 23, 12, 923, DateTimeKind.Utc).AddTicks(8190));
