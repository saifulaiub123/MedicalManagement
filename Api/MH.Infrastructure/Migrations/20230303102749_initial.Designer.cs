...
namespace MH.Infrastructure.Migrations
{
    ...
    [Migration("20230303102749_initial")]
            ...
            modelBuilder.Entity("MH.Domain.DBModel.City", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 629, DateTimeKind.Utc).AddTicks(2213));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 629, DateTimeKind.Utc).AddTicks(3607));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.Country", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 629, DateTimeKind.Utc).AddTicks(6062));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 629, DateTimeKind.Utc).AddTicks(7119));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.State", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 676, DateTimeKind.Utc).AddTicks(4196));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 3, 10, 27, 48, 676, DateTimeKind.Utc).AddTicks(5418));
