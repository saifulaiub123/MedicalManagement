...
namespace MH.Infrastructure.Migrations
{
    ...
    [Migration("20230308053643_add-new-tables")]
            ...
            modelBuilder.Entity("MH.Domain.DBModel.City", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 413, DateTimeKind.Utc).AddTicks(5841));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 413, DateTimeKind.Utc).AddTicks(8171));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.Country", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 416, DateTimeKind.Utc).AddTicks(2756));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 416, DateTimeKind.Utc).AddTicks(4642));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.State", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 495, DateTimeKind.Utc).AddTicks(6357));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 5, 36, 42, 495, DateTimeKind.Utc).AddTicks(7617));
