...
namespace MH.Infrastructure.Migrations
{
    ...
    [Migration("20230308113801_modify-configuration")]
            ...
            modelBuilder.Entity("MH.Domain.DBModel.City", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 359, DateTimeKind.Utc).AddTicks(6515));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 359, DateTimeKind.Utc).AddTicks(8700));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.Country", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 361, DateTimeKind.Utc).AddTicks(9984));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 362, DateTimeKind.Utc).AddTicks(1930));
            ...
            modelBuilder.Entity("MH.Domain.DBModel.State", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 431, DateTimeKind.Utc).AddTicks(3443));

                    b.Property<DateTime?>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 3, 8, 11, 38, 0, 431, DateTimeKind.Utc).AddTicks(5116));
